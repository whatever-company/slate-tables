...
/** Cell data with `span` ('colspan' or 'rowspan') set, the key being dropped for the default of 1 */
export function withSpan(data, span, value) {
	return value === 1 ? data.delete(span) : data.set(span, value)
}
